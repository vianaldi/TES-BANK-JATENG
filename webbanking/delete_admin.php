...
<?php
include 'dbconn.php';
$sql="SELECT * FROM `admin` WHERE department='finance'";
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    ...
    <title>Delete Admin</title>
                ...
                <form action="editcustomer.php" method="POST">
                    ...
                    <input type="submit" name="submit2_id" value="EDIT ADMIN DETAILS" class='btn btn-info' onclick="javascript: form.action='editadmin.php';"/>
                    <input type="submit" name="submit2_id" value="DELETE ADMIN" class='btn btn-danger' onclick="javascript: form.action='deleteadmin.php';"/>
                </form>
                </div>
                </div>
    </body>
